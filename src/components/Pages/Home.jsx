...
const Home = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>Dark Creative - Geliştirici</title>
        <meta name="description"
          content="Web tabanlı uygulamalar geliştiriyor ve Discord botları ile ilgileniyorum. Portföyüm ve becerilerim için URL Dark Creative adresini ziyaret edin." />
      ...
      <div className='flex justify-center py-48 text-center'>
        <div>
          <h1 className='font-bold text-4xl sm:text-6xl'>Merhaba Ben <span className='text-sky-500 underline'>Dark Creative</span></h1>
        ...
        <div className='gap-4 p-4 sm:py-8 sm:px-14 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-4 gap-y-4'>
          {repositories.length > 0 ? (
            repositories.sort((a, b) => b.stargazers_count - a.stargazers_count).map((repositorie) => (
              repositorie.name !== 'Dark Creativey' && (
